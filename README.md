...
> ##### 현재 구현된 기능 : 로그인, 회원가입, 프로필 등록/수정, 이미지 등록, 이미지 공개/비공개 설정, 댓글 등록/수정 <br/>
>
> ##### 앞으로 구현 할 기능 : 이미지 수정, 좋아요 기능, 팔로우/팔로잉 등록, DM 기능, 유저 검색 기능

##### 참고 : [youngstagram issues](https://github.com/kyw0716/Youngstagram/issues)
...
##### 토익을 준비하던 여자친구가 온라인 스톱워치를 사용하는 것을 보고 광고 없는 스톱워치를 만들어 주고자 시작한 프로젝트
